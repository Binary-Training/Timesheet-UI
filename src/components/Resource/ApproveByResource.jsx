        ...
        <div>
            ...
            <div className='container main-border mt-4'>
                <div>
                    <nav className="navbar navbar-light bg-light mt-4">
                        <div className="container-fluid fw-bold">
                            <ol className="breadcrumb ms-3 text-size">
                                <li className="breadcrumb-item">Resource View</li>
                ...
                <fieldset className="container border">
                    ...
                    <table className="table table-bordered table-striped text-center">
                        <thead>
                            <tr>
                                ...
                                <th><span> Rejected <br></br> Hours(s) <i className="bi bi-arrow-down-up"></i></span></th>
                                <th><span> Regular <br></br> Submitted <br></br> Hour(s) <i className="bi bi-sort-down"></i></span></th>
                                <th><span> OverTime <br></br> Submitted <br></br> Hour(s) <i className="bi bi-sort-down"></i></span></th>
                                <th><span>Not Submitted<br></br> Hours(s) <i className="bi bi-sort-down"></i></span></th>
                    ...
                    <div className='row'>
                        <div className='col-2'>
                            <button type="button" className='button btn-lg'>Export</button>
                        </div>
