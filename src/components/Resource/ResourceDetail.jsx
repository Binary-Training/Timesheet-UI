  ...
  <ol className="breadcrumb ms-3">
    ...
    <li className="breadcrumb-item"><a href="/" className="text-decoration-none">Feb4 User5</a></li>
                ...
                <fieldset className="container border">
                    <legend className="float-none w-auto p-2 text-color">Resource Detail</legend>
                    ...
                    <table className="table table-bordered table-striped text-center">
                        <thead>
                            <tr>
                                <th>Resource Name</th>
                                <th><span> Project <br></br> Name </span></th>
                                <th><span> Project <br></br> Manager <br></br>Name <i className="bi bi-arrow-down-up"></i> </span></th>
                                <th><span> Project <br></br> Description <i className="bi bi-arrow-down-up"></i> </span></th>
